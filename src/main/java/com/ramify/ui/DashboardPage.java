...
import com.ramify.manager.EventManager;
...
public class DashboardPage {
    ...
    public static Scene getScene(Stage stage, Scene previousScene) {
        ...
        try {
            settingsIcon = new ImageView(new Image("/images/settingsicon.png"));
        ...
        try {
            logoutIcon = new ImageView(new Image("/images/logouticon.png"));
        ...
        try {
            sideLogo = new ImageView(new Image("/images/logosidebar.jpg"));
        ...
        try {
            logoView = new ImageView(new Image("/images/ramify_logo.png"));
        ...
        try {
            flyerImage.setImage(new Image("/images/Ramchella.png"));
        } catch (Exception ignored) {}
